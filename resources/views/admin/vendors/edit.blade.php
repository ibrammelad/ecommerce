                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.Vendors.update' , $vendor->id)}}"  method="POST"
                                            ...
                                            @csrf
                                            @method("PATCH")
                                            <input name="id" type="hidden" value="{{bcrypt($vendor->id)}}">
                                            <input name="latitude" type="hidden" value="{{$vendor->latitude}}">
                                            <input name="longitude" type="hidden" value="{{$vendor->longitude}}">
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                        src="{{$vendor -> logo}}"
                                                        class="rounded-circle  height-150" alt=" لوجو التاجر  ">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                ...
                                                                name="category_id" class="select2 form-control">
