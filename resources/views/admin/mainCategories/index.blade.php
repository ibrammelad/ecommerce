                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">جميع الاقسام الرئيسية في الموقع </h4>
                                            ...
                                            @isset($mainCategories)
                                                @foreach($mainCategories as $mainCategory)
                                                     <tr>
                                                         ...
                                                         <td>{{__('messages.'.$mainCategory->translation_lang)}}</td>
                                                         <td>{{$mainCategory->getActive()}}</td>
                                                         <td> <img style="width: 150px; height: 100px;" src="{{$mainCategory->photo}}"></td>
                                                         <td>
                                                            ...
                                                            <a href="{{route("admin.maincategories.delete" ,$mainCategory->id )}}"  class="btn btn-outline-danger btn-min-width box-shadow-3 mr-1 mb-1">حذف</a>
                                                             <a href="{{route('admin.maincategories.changestatus' ,$mainCategory->id )}}"
                                                                class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">
                                                                 @if($mainCategory->active == 1) الغاء التفعيل @else تفعيل @endif </a>
