    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">الاقسام اىرئيسية  </span>
                    <span
            class="badge badge badge-danger badge-pill float-right mr-2">{{\App\Models\MainCategory::where('translation_of' , 0)->count()}}</span>
                </a>
                <ul class="menu-content">
            ...
            <li class=" nav-item"><a href="#"><i class="la la-fire"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    ...
                    we                    <li><a class="menu-item" href="card-maps.html" data-i18n="nav.cards.card_maps">Maps</a>
                    </li>
